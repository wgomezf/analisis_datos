...
*   Evaluación de clasificadores
        *   [`Validación cruzada en clasificación binaria`](https://github.com/wgomezf/analisis_datos/blob/main/02_Clasificación_lineal/kfoldbin.ipynb) 
        *   [`Validación cruzada en clasificación multiclase`](https://github.com/wgomezf/analisis_datos/blob/main/02_Clasificación_lineal/kfoldmul.ipynb) 
